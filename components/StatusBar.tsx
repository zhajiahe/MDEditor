...
export const StatusBar: React.FC<StatusBarProps> = ({ text, cursorPos }) => {
  ...
  return (
    <div className="h-7 bg-white dark:bg-[#1e1e1e] border-t border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 text-[11px] font-mono text-gray-500 dark:text-gray-400 select-none transition-colors duration-200">
